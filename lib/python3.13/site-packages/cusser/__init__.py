...
class Cusser:
    ...
    def __post_init__(self):
        ...
        # TODO: initialize the same colors curses does by default, see defaults in
        # [curses.start_color](https://docs.python.org/3/library/curses.html#curses.start_color)
        # (check their RGB values with
    ...
    def _set_color(self, role: ColorRole, color: ochre.Color) -> None:
        ...
        match role:
            case ColorRole.FOREGROUND: self.color_manager.foreground = color
            case ColorRole.BACKGROUND: self.color_manager.background = color
            
            case _: raise ValueError(f"Unknown color role {role}")

...
c.monologue = {
    "HL" : [
        ...
        "후...힘든데....",
        "좀... 쉴까? 온몸에서 멀쩡한 곳이 적어...",
        "온몸에서 식은땀이 흘러... 아, 기분 탓이었네. 내가 땀샘이 있을 리 만무하잖아?",
    ...
    "HUL" : [
        ...
        "너무 배고파 이 던전 벽이라도 씹어 먹고 싶어 이 던전 벽은 원래 맛있어 보였으니까 맛있게 뜯어먹어도 되겠지? 단단한지는 상관없어 아소투스가 나에게 벽을 요리해 줄 거야... 벽을... 요리... 벽...",
        "제대로 된 식량을 아소투스가 요리해 줬으면 하는데 아소투스가 요리할 식재료가 필요해... 당장이라도 다음 식재료를 찾자.",
        "으어....................배고...파..죽....는...다.........",
        "당장 떠오르는 요리 레시피만 하더라도 158개의 요리 레시피가 떠오르고 내가 완벽히 기억하는 요리 레시피는 총합 384862개야. 그런데 이런 레시피들을 지금 당장 활용할 수 없어? 왜 나는... 요리할 수 없어? 왜 나는 고통받아? 왜 나만? 왜? 왜?",
        "세상이 너무 불공평한 거 같아. 나는 음식을 먹을 수 없다고? 나는 왜 음식을 먹을 수 없는거야? 왜 바닥이 흙이 아닌거야? 진흙 쿠키라도 소화 가능해서 좋은데...?",
        "지금 당장 초콜릿이 있었다면 나는 당장 초콜릿을 조리해서 먹었을 거야. 어째서 인지 내 몸이 초콜릿만을 분해하지 못하고 독성을 보이지만... 그래도 그 독성 가득한 초콜릿을 나는 원해...",
        "파이...... 파스타... 스테이크... 만두... 찜... 국... 스튜... 수프...",
        "흐윽...우흐으...흐으으악으흑크흑... 우..우는 거 아니야... 젠장... 히윽...",
    ],
    "CO" : [
        "뭔가 익숙한 것들이 몸을 조여오는걸?",
    ...
    "ELS" : [
        ...
        "그는 말했다. '사람들 사이에 있더라도 외롭기는 마찬가지야.' 나는 그것에 답했다. '나는 근처에 기댈 사람은 커녕 사람 자체가 없는걸?'... 젠장.",
        "아... 돌이라도 끓여먹고 싶은 하루야... 근데... 맛있을려나? 회색맛이 나겠지?",
        "나도 가끔은 조리해먹기 귀찮을 때가 있어. 그럴때에 나는 조리를 안하고 생으로 먹지. 음... 이 잿가루는 깊은 맛을 내면서도 씁쓸하고 매콤한게 맛있는데?",
...
c.enterinBattle = {
    ...
    5 : [
        ...
        "오늘은 잔칫상을 만들 수 있겠네. 오늘이 아니라 어제인가?",
        "... 아 군침 돌았어.",

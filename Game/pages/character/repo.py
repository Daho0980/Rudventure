...
c.monologue = {
    "cmt" : {
        "HL" : [
            "아픈 건 싫은데...",
            "이러다 망가진 깃털 수가 멀쩡한 깃털 수보다 많아질 것 같아!",
            "후...힘든데....",
            "좀... 쉴까? 온몸에서 멀쩡한 곳이 적어...",
            [
                "온 몸에서 식은땀이 흘러...",
                "아, 기분 탓이었네. 내가 땀샘이 있을 리 없잖아?"
            ],
            "배고프진 않지만... 내장이 파열된 거 같아...",
            "으음... 나만 알고 있는 레시피를 적은 유언장을 사용할 날이 곧 올 것 같아.",
            "으윽...뼈가 쑤시네...",
        ...
        "HUL" : [
            ...
            [
                "당장 떠오르는 요리 레시피만 하더라도 158개의 요리 레시피가 떠오르고, 내가 완벽히 기억하는 요리 레시피는 총합...",
                "384862개야."
        ...
        "ELS" : [
            ...
            [
                "서늘한 게 냉장고가 필요 없을 것 같아...",
                "물론 식재료에 저주만 묻지 않는다면 말이야."
            ],
            "난 고양이가 무서워...",
            "이곳은 어떻게 빠져나갈까... 뭐 상관없나?",
            "이곳의 시간은 참 이상한 거 같아. 어떨 땐 뒤로 어떨 땐 옆으로도 흘러.",
            [
        ...
        "hpLow" : {
            "cmt" : {
                "S" : [
                    ...
                    "더 없어? 정말? 진짜로?",
                    "나 아직 아프다고...",
                    "이거 약간 피 맛이 나는 것 같은데... 아, 내 입에서 나는 피구나.",
                    "...나 살아있는 건 맞지? 방금 전에 눈 앞이 캄캄해졌었다구..."
                ],
                "B" : [
                    "...그나마.",
                    "하아... 고비는 넘긴거 같은데?",
    ...
    "ásotus" : {
        ...
        "use" : {
            "cmt" : [
                ["지글지글...", "짜잔! 완성!"],
                ["이걸 이렇게... 이건 저렇게...", "짜잔! 완성!"],
                ["흐음... 아무래도 이건 이게 나을 것 같고...", "짜잔! 완성!"],
                ["여기에 폴리에스테린 장식만 하면...", "짜잔! 완성!"],
                ["썰고 볶고 튀기고 삶고 갈고...", "짜잔! 완성!"],
                ["짜잔!", "어? 잠깐만......", "진짜 완성!"],
                ["이 부분을 재구성해서... 이렇게 만들고... 식감은... 됐다.", "짜잔! 완성!"],
                ["이것만 올리고... 이것도 볶아서 올리면...", "짜잔! 완성!"],
            ],
            "prob" : 100
        },
        "attack" : {
            "cmt" : [                
                ...
                "아소투스는 험한 일 시키면 안 돼!",
                "아소투스는 정밀한 연금술 장치라고!",
                "소중히 다뤄줘! 아소투스는 나의 일부라고.",
                "아소투스는 부드럽고 소중하게 다뤄야 해!",
                [
                    "아소투스!",
                    "어디 다친 데는 없어?",
                    "금 가거나 뻐근하거나 상처 나거나 연금술 도금이 벗겨진 곳은?",
                    "없어?",
                    "휴, 다행이다."
                ],
                "아소투스는 휘두른다고 음식을 만들지 않아!",
            ],
            "prob" : 50
        },
        "put" : {

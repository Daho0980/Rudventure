...
collide:dict[str,dict[str,list[str]]] = {
    "animal" : {
        "cat" : [
            "?",
            "뭐야.",
...
# 좋다, 미개한 글라가트로프여. 기어이 1/6의 확률을 뚫고 여기까지 도달했구나.
# 내 너를 위해 위대한 선물(맛있다)을 내리노니,
# 젤리곰이나 받아라 yeet
...
enterinBattle:dict[int,list[str|str]] = {
    0 : [
        "가보자고.",
        "이번에도, 어김없이.",
        "또 왔군.",
...
getOrb:dict[str,dict[str,dict[str,list[str]]]] = {
    "hp" : {
        "hpLow" : {
            "S" : [
                "아직... 부족해.",
